...
/// struct for typed errors of method `put_marketing_materials_templates_uuid_publish`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum PutMarketingMaterialsTemplatesUuidPublishError {
...
pub async fn put_marketing_materials_templates_uuid_publish(configuration: &configuration::Configuration, uuid: &str, marketing_material_template_publish_payload: Option<crate::models::MarketingMaterialTemplatePublishPayload>) -> Result<(), Error<PutMarketingMaterialsTemplatesUuidPublishError>> {
    ...
    local_var_req_builder = local_var_req_builder.json(&marketing_material_template_publish_payload);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<PutMarketingMaterialsTemplatesUuidPublishError> = serde_json::from_str(&local_var_content).ok();
